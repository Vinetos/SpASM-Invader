...
IsSpriteColliding						;a1 = adresse sprite 1 , a2 = adresse sprite 2
										; Z = 0 si pas de collision Z = 1 si collision
				...
				cmp.w	(a7),d3			; Si Y coin inf droit 2 < Y coin sup gauche 1
				bls		\no_collision2
				cmp.w	4(a7),d1		; si X coin sup gauche 2 > X coin inf droit 1
				bhi		\no_collision2
				cmp.w	2(a7),d4		; si X coin inf droit 2 < X coin sup gauche 1
				blo		\no_collision2
				cmp.w	6(a7),d2		; si Y coin sup gauche 2 > Y coin inf droit 1
				bhi		\no_collision2
				
\collision		adda.l #8,a7
				movem.l	(a7)+,d1-d4/a0
				or.b	#%00000100,ccr
				rts

\no_collision2	adda.l #8,a7
\no_collision1	movem.l	(a7)+,d1-d4/a0
				and.b	#%11111011,ccr
				rts
;-------------------------------------------------
